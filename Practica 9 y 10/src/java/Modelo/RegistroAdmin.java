...
public class RegistroAdmin extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ad.user = request.getParameter("user");
            ad.pass = request.getParameter("pass");
            ad.email = request.getParameter("email");
            ad.fechaNac = request.getParameter("fechaNac");
            ad.tipo_Usuario = "Admin";
